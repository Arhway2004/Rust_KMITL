...
use clap::{App, Arg};
use std::error::Error;
use Lab::{RangeConfig, CirclePara, Point, Locate, gen_point_list, locate_n_point};
use svg::Document;
...
// use clap::{App, Arg};
// use std::error::Error;
// use Lab::{RangeConfig, CirclePara, CirclePara2, Point, Locate2, Bound, gen_point_list, locate_n_point2};
// use svg::Document;
// use svg::node::element::Circle;
// use std::io::Result;
